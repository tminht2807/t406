...
Red_Light_Cascade = cv2.CascadeClassifier("D:\\OKhe\\bosch\\Traffic_sign\\weekend\\Cascade_detect_full\\cascadered.xml")
Yellow_Light_Cascade = cv2.CascadeClassifier("D:\\OKhe\\bosch\\Traffic_sign\\weekend\\Cascade_detect_full\\cascadeyellow.xml")
Green_Light_Cascade = cv2.CascadeClassifier("D:\\OKhe\\bosch\\Traffic_sign\\weekend\\Cascade_detect_full\\cascadegreen.xml")

# Khởi tạo CascadeClassifier và đọc tệp xml cho biển báo stop và parking
Stop_Cascade = cv2.CascadeClassifier("D:\\OKhe\\bosch\\Traffic_sign\\weekend\\Cascade_detect_full\\cascade.xml")
Parking_Cascade= cv2.CascadeClassifier("D:\\OKhe\\bosch\\Traffic_sign\\weekend\\Cascade_detect_full\\parking_cascade.xml")
