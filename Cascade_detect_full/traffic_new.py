...
Red_Light_Cascade = cv2.CascadeClassifier("C:\\Users\\Phong Phung\\Desktop\\l\\test\\classifier\\cascade.xml")
Yellow_Light_Cascade = cv2.CascadeClassifier("C:\\Users\\Phong Phung\\Desktop\\testyellow\\classifier\\yellowcascade.xml")
Green_Light_Cascade = cv2.CascadeClassifier("C:\\Users\\Phong Phung\\Desktop\\testgreen\\classifier\\greencascade.xml")
...
while True:
    ...
    if dist_Stop < 20 & dist_Stop > 5:
        send_command(1,0)
        time.sleep(2000)			# lat nua fix lai ham chuan cua no
        send_command(1,10)
        time.sleep(2000)
